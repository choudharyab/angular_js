...
balanceSheetModule.controller('balanceSheetController',['$rootScope','$scope','$location','$timeout','$route','getWarehouseListService','getCaptialAccountDataService','getLoansDataService','getCurrentDataService','getSuspenseAccountDataService','getTaxDutiesDataService','getCurrentAssetsDataService','getFixedAssetsDataService','getInvestmentDataService','getBranchDataService','sundryCreditorDateService','sundryDebtorDateService','getProvisionAccountDataService','getLoanAdvanceAccountDataService','getBankCashService','getNetProfitAmountService',
    ...
    $scope.show_capital_details=function(ind,ledger_type,ledger_id){
		
		if(ledger_type == 'Ledger')
		{
			$location.path('/capitalamountmonthwise/'+ledger_id+'/'+$rootScope.from_date+'/'+$rootScope.to_date+'/'+$scope.waree_id);
		}else{
			$scope.capital_liab_arry=[];
	...
	$scope.allbalancesheetlist=function(){
		...
		getCaptialAccountDataService({
	     ...
	     from_date:$rootScope.from_date,
				...
				//var pro_amt= res.data.total_amt;
                 $scope.net_profit = res.data.total_amt;
				 console.log($scope.net_profit);
