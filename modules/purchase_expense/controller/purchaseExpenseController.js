var purchaseExpenseController = angular.module('allPurchaseExpenseModule',[]);

purchaseExpenseController.controller('allPurchaseExpenseController',['$scope','$http','$route','$window','$location','$timeout','getAccLedgerListService','taxesService','ExpSupplierAutoCompleteService','ExpSupplierProductByIdService','savePurchaseExpenseService','ExpListingService','getNextExpenseSupplierCode','getExpenseProductsAutocomplete','getProductByIdService','addExpenseSupplierService','getExpenseByIdService','updatePurchaseExpenseService','commonService','getVoucherLedgerListService','getUnitOfMeasureService','getTaxRateService','addProductForExpenseOrder','getStateListService','getWarehouseListService','getBillFileService',function ($scope,$http,$route,$window,$location,$timeout,getAccLedgerListService,taxesService,ExpSupplierAutoCompleteService,ExpSupplierProductByIdService,savePurchaseExpenseService,ExpListingService,getNextExpenseSupplierCode,getExpenseProductsAutocomplete,getProductByIdService,addExpenseSupplierService,getExpenseByIdService,updatePurchaseExpenseService,check_permission,getVoucherLedgerListService,getUnitOfMeasureService,getTaxRateService,addProductForExpenseOrder,getStateListService,getWarehouseListService,getBillFileService) {
	...
	$scope.getComposition = function(){
        $('#auto_pro_code_id').autocomplete({
            ...
            select:function (event,ui) {
				...
				$scope.data.products = {product_id:ui.item.id, product_name:ui.item.product_name, hsn_code:ui.item.hsn_code, tax_rate:ui.item.tax_rate, pro_amount:"", tax_amt:"", total_amt:"",rate: "", quantity: ""};
