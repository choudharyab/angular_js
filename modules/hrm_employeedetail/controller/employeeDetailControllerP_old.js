...
employeeDetailModule.controller('employeeDetailController',['$rootScope','$scope','$location','$route','$http',
  'getHrmGeneralMaritalStatusListing','getHrmGeneralDepartmentListing','getHrmGeneralDesignationListing',
  'getHrmGeneralCategoryListing','getStateListService',
  'getHrmSalaryComponentListing','getHrmGeneralBloodGroupListing','getHrmGeneralCompanyEmailListing',
  'getSalaryConfigurationListing','getEmployeeListing','getWarehouseListService',
  'getHrmGeneralProbationPeriodListing','getHrmGeneralNoticePeriodListing','editEmployeeDetailsService',
  'updateEmployeeDetailService','deleteEmployeeDetails','getSalaryConfigurationListing',
  function($rootScope,$scope,$location,$route,$http,getHrmGeneralMaritalStatusListing,getHrmGeneralDepartmentListing,getHrmGeneralDesignationListing,getHrmGeneralCategoryListing,getStateListService,getHrmSalaryComponentListing,getHrmGeneralBloodGroupListing,getHrmGeneralCompanyEmailListing,getSalaryConfigurationListing,getEmployeeListing,getWarehouseListService,getHrmGeneralProbationPeriodListing,getHrmGeneralNoticePeriodListing,editEmployeeDetailsService,updateEmployeeDetailService,deleteEmployeeDetails,getSalaryConfigurationListing){
    $scope.currencyIndex = localStorage.getItem('currencyCode');
    $scope.currencyValue = localStorage.getItem('currencyRate');
    $scope.currencySymbol = localStorage.getItem('symbolCode');
    ...
    console.log(JSON.stringify($scope.employee));
        ...
        $http({
         ...
         // console.log('==============>>>>',$scope.images);
            ...
            data: {employee: $scope.employee,files: $scope.files}
        }).

        success(function (data, status, headers, config) {
           console.log('data---->',data);
            console.log("success!");
            //$location.path('/formstall');
        }).
...
*/
 ...
 /*   $scope.calculate_allowance = function(arr,ind){
      if($scope.gross_amount != '' && $scope.gross_amount != undefined){ 
       console.log("checkbox value---------->",arr[ind].id);   
         if(arr[ind].id == true){
