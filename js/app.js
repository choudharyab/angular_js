...
//var appUrl = "http://wheelsonroad.tectureproducts.in/wheelsonroadserver/api/";
 ...
 var appUrl = "http://localhost/wheelsonroad/wheelsonroadserver/api/";
...
angular.module('myApp', [
  ...
  'customerStatusModule','fleetListModule','caseScrutinyModule','caseManagementModule','purchaseRequisitionModule','goodReceivingModule',
    ...
    'crmFollowSheetModule','accountLedgerModule',
    ...
    'fleetMaintenanceReportModule','accountLedgerModule','cashClientReportModule','gstr1Module','subLedgerModule','monthWiseModule','dateWiseModule',
    'gstr3bModule','accProfitLossModule','fleetDieselRecordModule','cashCaseManagementModule',
    'awpTollReportModule','policyRuleModule','policyDetailsModule','accountLedgerAccModule','trialBalanceModule','policyUserModule','cancelCaseManagementModule','expenseProductModule','expenseSupplierModule','invoiceServiceModule','allPurchaseExpenseModule'
]).
...
$routeProvider.when('/closedCaseManagement', {templateUrl: 'modules/caseManagement/view/closedCaseManagement.html',controller:'caseManagementController'});
...
/* ac opening balance */
 ...
 $routeProvider.when('/policy_user', {templateUrl: 'modules/policy_users/view/policy_user.html', controller:'policyUserController'});
$routeProvider.when('/cancelledCaseManagement', {templateUrl: 'modules/caseManagement/view/cancelledCaseManagement.html', controller:'cancelledCaseManagementController'});
	
  //..........Purchase Expense.............//

    $routeProvider.when('/purchaseexpense', {templateUrl: 'modules/purchase_expense/view/purchase_expense.html',controller:'allPurchaseExpenseController'});
  
  //..........Expense Supplier.............//
  
  $routeProvider.when('/expensesupplier', {templateUrl: 'modules/expense_supplier/view/expense_supplier.html',controller:'expenseSupplierController'});
  // ............... Expense Product ................//

    $routeProvider.when('/expenseproduct', {templateUrl: 'modules/expense_product/view/expense_product_list.html', controller: 'expenseProductController'});
  
$routeProvider.when('/invoice_service',{templateUrl: 'modules/invoice_services/view/invoice_service.html', controller: 'invoiceServiceController' }); 
